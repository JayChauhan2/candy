    ...
    <main className="kingdom-home" aria-label="Kingdom game home">
      ...
      <aside className="kh-builder" aria-label="Builder monument menu">
        ...
        <div className="kh-builder-list">
          ...
          <div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','castle');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="castle" /><b>CASTLE</b></div><div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','cottage');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="cottage" /><b>COTTAGE</b></div>
          <div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','stable');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="stable" /><b>STABLE</b></div><div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','storage');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="storage" /><b>STORAGE</b></div>
          <div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','farm');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="farm" /><b>FARM</b></div><div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','windmill');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="windmill" /><b>WINDMILL</b></div>
          <div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','well');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="well" /><b>WELL</b></div><div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','market');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="market" /><b>MARKET</b></div>
          <div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','trainingyard');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="trainingyard" /><b>TRAINING YARD</b></div><div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','campfire');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="campfire" /><b>CAMPFIRE</b></div>
          <div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','signpost');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="signpost" /><b>SIGNPOST</b></div><div draggable onDragStart={(event)=>{event.dataTransfer.setData('application/x-candy-monument','lantern');event.dataTransfer.effectAllowed='copy'}}><BuilderMonumentPreview type="lantern" /><b>LANTERN</b></div>
        </div>
      </aside>
