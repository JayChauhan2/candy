...
export const mountClashVillageScene = (host: HTMLDivElement) => {
    ...
    const placeBuilderMonument=(type:BuilderType,x:number,z:number,isPreview=false)=>{
      ...
      let buttonHeight=3
      if(type==='house'){add(new THREE.CylinderGeometry(1.02,1.16,1.42,8),0xe0bd78,.8);add(new THREE.ConeGeometry(1.42,1.28,7),0xc85b43,2.12);const door=add(new THREE.BoxGeometry(.48,.74,.08),0x71483a,.45);door.position.z=1.18;buttonHeight=3.2}
