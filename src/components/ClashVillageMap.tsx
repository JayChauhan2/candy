...
export const mountClashVillageScene = (host: HTMLDivElement) => {
    ...
    if(confirmCtx){confirmCtx.fillStyle='#4dc95b';confirmCtx.font='700 62px Arial';confirmCtx.textAlign='center';confirmCtx.textBaseline='middle';confirmCtx.fillText('✓',48,52)}
