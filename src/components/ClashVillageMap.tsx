...
export const mountClashVillageScene = (host: HTMLDivElement) => {
    ...
    const troopShowcase:{group:THREE.Group;legs:THREE.Mesh[];phase:number;cx:number;cz:number;speed:number}[]=[]
